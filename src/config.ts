export const config = {
    ...
    skills: {
        develop: {
            ...
            details: "Building responsive, fast, and accessible web applications with React, Next.js, Node.js, and databases. Crafting seamless user experiences with modern UI principles.",
